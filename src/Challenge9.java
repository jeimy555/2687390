...
public class Challenge9 {
    public static void main(String[] args) {
        ...
        int bet,bet2,winner,op,number1,number2,acumulador,bet3,contador;
//inicializar variables
        op=0;
        acumulador=0;
        winner=0;
        contador=0;
        number1=(int)(Math.random()*2+1);
//apuesta inicial
        System.out.println("ingresa el valor de la apuesta inicial");
        bet=leer.nextInt();

        
//inicio de bucle y posibilidad de ingresar apuesta cada vez que juega        
        do {
...
//situaciones que ocurren segun que numero elija el jugador        
        switch (number2) {
            case 1:
            if (number1==1 && number1==number2 && bet2<=bet) { 

            System.out.println("usted ah elegido cara y es el ganador");
            winner=bet2*2;
            ...
            System.out.println("usted ah elegido cruz y es el ganador");
            winner=bet2*2;
            System.out.println("usted ah ganado con esta apuesta un total de "+winner);
...
//definir valor de el acumulador, contador y de la apuesta final
...
//opcion de si el jugador quiere seguir jugando, si elije 1 se repetira todo desde la linea 26
...
//lo que sucede si el jugador pone cualquier numero diferente a 1 
